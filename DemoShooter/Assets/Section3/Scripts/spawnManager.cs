...
namespace Section3
{
    ...
    public class spawnManager : MonoBehaviour
    {
        ...
        [SerializeField] private projectileController m_playerProjectilePool;
        [SerializeField] private projectileController m_enemyProjectilePool;
        ...
        ////đợi 1 khoảng tgian r mới tiếp tục tiến trình
        //private IEnumerator IETestCoroutine()
        //{
        //    yield return new WaitUntil(() => m_active);
        //    //vong lap chay tu 0 den 5
        //    for (int i = 0; i < 5; i++)
        //    {
        //        Debug.Log(i);
